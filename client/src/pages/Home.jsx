...
// // ======================================================
// // NAHOME FILM PRODUCTION BACKEND
// // Wedding / Bridal / Baby Shower data comes from here
// // ======================================================
// //
// // IMPORTANT:
// // We intentionally use the Nahome backend directly.
// // This prevents an old VITE_HABESHA_BACKEND_URL
// // environment variable from sending the Home page
...
// // ======================================================
// // FIX IMAGE URL
// // This is specifically for images coming from
// // the Nahome Film Production backend.
// // ======================================================
...
//       {/* ==================================================
//           WEDDING / BRIDAL / BABY SHOWER
//           FROM NAHOME FILM PRODUCTION SERVER
//       ================================================== */}
...
//             IMPORTANT:
//             No backend section is passed here.
//             MusicSection uses its LOCAL data.
//         ================================================= */}
...
const fixImageUrl = (url) => {
  ...
  if (
    ...
    // Old localhost 5000 → Nahome server
    if (
      cleanUrl.startsWith(
        'http://localhost:5000'
      )
    ...
    // Old localhost 4000 → Nahome server
    if (
      cleanUrl.startsWith(
        'http://localhost:4000'
      )
...
const parseProject = (section = {}) => {
  ...
  try {
    ...
    if (
      ...
      // ------------------------------------------------
      // New format
      // descriptions ||HEADINGS|| headings
      // ------------------------------------------------
  ...
  // ====================================================
  // IMAGES
  // SERVER / DATABASE / CLOUDINARY ONLY
  // ====================================================
...
// ======================================================
// CHECK WEDDING CONTENT
// ======================================================

const isWeddingContent = (
  section = {}
) => {
...
function Home() {
  ...
  return (
    ...
    >
      ...
      {/* ==================================================
          FILM PRODUCTION
          KEEPING YOUR EXISTING LOCAL LOGIC
      ================================================== */}
