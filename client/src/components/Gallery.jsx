...
function Gallery() {
  ...
  if (loading) {
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white/90 flex items-center justify-center">

        <p className="text-xl tracking-widest uppercase text-[#FF4900] animate-pulse">
          Loading Gallery...
        </p>
  ...
  if (!projectData) {
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white/90 flex flex-col items-center justify-center px-4">

        <h2 className="text-2xl font-serif text-[#FF4900] mb-4">
          Gallery Not Found
        </h2>
        ...
        <Link
          to="/"
          className="text-xs uppercase tracking-[0.3em] text-zinc-300 border border-[#FF4900]/40 px-6 py-3 rounded hover:bg-[#FF4900] hover:text-black transition"
        >
          ← Back to Home
        </Link>
  ...
  return (
    ...
    <div
      className="min-h-screen bg-[#0a0a0a] text-white/90 px-3 py-12 md:px-20 select-none"
      onContextMenu={(e) =>
        e.preventDefault()
      }
    >
      ...
      <div className="mb-10 pt-16 md:pt-4">
        ...
        <Link
          to="/"
          className="text-xs uppercase tracking-[0.3em] text-zinc-400 hover:text-[#FF4900] border border-[#FF4900]/30 px-4 py-2 rounded transition"
        >
          ← Back to Home
        </Link>
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-6xl font-serif italic text-[#FF4900] capitalize mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6">
          ...
          {projectData.images.map(
            (img, index) => (
              ...
              <div
                key={`${img}-${index}`}
                className="aspect-[2/3] overflow-hidden bg-zinc-900 rounded-md md:rounded-lg border border-[#FF4900]/30 shadow-lg relative group"
              >
                ...
                <div
                  ...
                  className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center cursor-pointer pointer-events-auto z-30"
                >

                  <span className="text-[#FF4900] text-[10px] md:text-xs uppercase tracking-widest bg-black/80 border border-[#FF4900]/50 px-3 py-1.5 rounded">
                    View
                  </span>
