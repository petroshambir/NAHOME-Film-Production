...
//         <div className="relative overflow-hidden rounded-[2rem] border border-[#dfb557]/20 bg-gradient-to-br from-[#151515] via-[#0b0b0b] to-black px-6 py-12 md:px-16 md:py-16 text-center">

//           <div className="absolute -top-32 -left-32 w-72 h-72 rounded-full bg-[#dfb557]/5 blur-3xl" />

//           <div className="absolute -bottom-32 -right-32 w-72 h-72 rounded-full bg-[#dfb557]/5 blur-3xl" />

//           <div className="relative">

//             <span className="text-[9px] md:text-[10px] uppercase tracking-[0.55em] text-[#dfb557] font-semibold">
...
//             <h2 className="mt-4 text-4xl sm:text-5xl md:text-7xl font-serif italic font-light">
//               {title}
//             </h2>
...
//               <span className="w-14 md:w-20 h-px bg-[#dfb557]/30" />

//               <span className="w-1.5 h-1.5 rounded-full bg-[#dfb557]" />
...
//                 <div className="group relative overflow-hidden rounded-2xl border border-[#dfb557]/20 bg-zinc-900">
...
//                     <h3 className="mt-2 text-xl md:text-2xl font-serif italic">
//                       {headings[index] || 'Wedding Moment'}
//                     </h3>


//                     {!preview && (
//                       <p className="mt-2 text-xs md:text-sm text-white/60 max-w-md">
//                         {descriptions[index] ||
