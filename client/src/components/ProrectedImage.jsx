...
// import adalLogo from '../assets/images/nahom-logo.jpeg'; 
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20 p-4">
        {showLogoOnly ? (
          ...
          <div className="w-full h-full flex flex-col justify-between items-center py-6 select-none opacity-60 group-hover:opacity-90 transition-opacity duration-300">
            
            {/* 🌟 እቲ ቀዳማይ (ኣብ ላዕሊ - ሰማያዊን ኣራንሾኒን) */}
            <div className="flex flex-col items-center text-center transform -rotate-6">
              <img 
                src={Logo} 
                alt="Habesha Logo" 
                className="w-5 h-5 md:w-7 md:h-7 object-contain mb-1 drop-shadow-[0_2px_4px_rgba(255,255,255,0.7)]"
              />
              <h2 className="text-sm md:text-xl font-serif font-bold tracking-[0.25em] uppercase text-[#2563eb] drop-shadow-[0_1px_2px_rgba(255,255,255,0.8)]">
                 NAHOME FILM PRODUCTION
              </h2>
              <p className="text-[8px] md:text-[10px] tracking-[0.4em] uppercase text-[#FF4900] font-bold mt-0.5">
                Protected Gallery
              </p>
            </div>

            {/* 🌟 እቲ ካልኣይ (ኣብ ታሕቲ - ሰማያዊን ኣራንሾኒን) */}
            <div className="flex flex-col items-center text-center transform -rotate-6">
              <img 
                src={Logo} 
                alt="Habesha Logo" 
