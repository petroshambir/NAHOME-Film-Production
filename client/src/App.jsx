...
//         {/* 1. ተጠቃሚ ናብ /gallery ጥራይ ምስ ዝኣቱ፡ ብኣውቶማቲክ ናብ /gallery/wedding ይቕየር */}
//         <Route path="/gallery" element={<Navigate to="/gallery/wedding" replace />} />
        
//         {/* 2. ንዝተፈላለዩ ካተጎሪታት ጋለሪ ዝቕበል ራውት */}
//         <Route path="/gallery/:category" element={<Gallery />} />
...
// import Welcome from './components/Welcome'; 
// import Gallery from './components/Gallery'; 
// import FilmSection from './components/FilmSection'; // Dedicated film page or list
// import AdminLogin from './components/AdminLogin'; 
// import AdminDashboard from './components/AdminDashboard'; 
// import ClientSelection from './components/ClientSelection';
...
//         {/* Dedicated Film Index Route */}
//         <Route path="/movies" element={<FilmSection preview={false} />} />
...
import MusicSection from './components/MusicSection'; // <-- 1. እዚ ኣእትዮ
import AdminLogin from './components/AdminLogin'; 
import AdminDashboard from './components/AdminDashboard'; 
import ClientSelection from './components/ClientSelection';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Dedicated Film & Music Index Routes */}
        <Route path="/movies" element={<FilmSection preview={false} />} />
        <Route path="/music" element={<MusicSection preview={false} />} /> {/* <-- 2. እዚ ራውት  ጨምረርኩሉ */}
